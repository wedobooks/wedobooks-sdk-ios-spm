...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "WeDoBooksSDK",
            url: "https://wdb-ios-spm-844218222632.europe-west1.run.app/WeDoBooksSDK-v1.0.3.xcframework.zip",
            checksum: "24bc60120566e5a9d4994d3b56f5e80bf20f41b1c36904bc0a889850c793c633"
        ),
        .binaryTarget(
            name: "ColibrioReader",
