...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "WeDoBooksSDK",
            url: "https://wdb-ios-spm-844218222632.europe-west1.run.app/WeDoBooksSDK-v0.9.0.xcframework.zip",
            checksum: "d0ed4124cd5169a69c3b8a1983c4e696693ac59506def8298a3e51f4e80592f5"
        ),
        .binaryTarget(
            name: "ColibrioReader",
