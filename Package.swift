...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "WeDoBooksSDK",
            url: "https://wdb-ios-spm-844218222632.europe-west1.run.app/WeDoBooksSDK-v1.4.0.xcframework.zip",
            checksum: "811c78c04f4266ff1e1b25745073fcfdd24c939d8ba36c9a1200d70fefca522e"
        ),
        .binaryTarget(
            name: "ColibrioReader",
