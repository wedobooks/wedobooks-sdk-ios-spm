...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "WeDoBooksSDK",
            url: "https://wdb-ios-spm-844218222632.europe-west1.run.app/WeDoBooksSDK-v1.3.0.xcframework.zip",
            checksum: "22e524161cb7c4191a9744fe66a30a93211bac7e32d9fc9ec1adbb2372490a54"
        ),
        .binaryTarget(
            name: "ColibrioReader",
