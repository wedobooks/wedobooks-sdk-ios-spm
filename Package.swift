...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "WeDoBooksSDK",
            url: "https://wdb-ios-spm-844218222632.europe-west1.run.app/WeDoBooksSDK-v1.2.1.xcframework.zip",
            checksum: "44e2732e10243755b837925b9e8194bfee38c6ac0798ee0645608f13f107bd83"
        ),
        .binaryTarget(
            name: "ColibrioReader",
